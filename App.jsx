...
const App = () => {
    ...
    return (
        <Router>
            <div className={`min-h-screen flex flex-col transition-colors duration-300 ${isDark ? 'dark bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
                <Navbar
                    user={user}
                ...
                <footer className="bg-white dark:bg-slate-900 border-t dark:border-slate-800 py-6 mt-12 transition-colors duration-300">
